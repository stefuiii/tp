...
* Case-insensitive
  * All text-based fields: `NAME` `COMPANY` `EMAIL` `TAG` are **case-insensitive**
    * 涉及到的功能：addbasic，add，edit，delete，find，sort
* Normalization
  * Extra spaces in fields will be automatically removed
  '''
  '''
