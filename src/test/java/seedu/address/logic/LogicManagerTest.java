...
import static seedu.address.logic.Messages.MESSAGE_INVALID_PERSON_INFO;
...
public class LogicManagerTest {
    ...
    public void setUp() {
        JsonAddressBookStorage addressBookStorage =
                new JsonAddressBookStorage(temporaryFolder.resolve("fastcard.json"));
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        ...
        assertCommandException(deleteCommand, MESSAGE_INVALID_PERSON_INFO);
    }
    ...
    @Test
    public void getFocusedPerson_filteredList_returnsCorrectPerson() {
        // Null Person Focused
        Person focused = logic.getFocusedPerson().get();
        assertNull(focused);
    }
